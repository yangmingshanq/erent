    ...
    <div class="reviewProductInfoDiv">
        ...
        <div class="reviewProductInfoRightDiv">
            ...
            <div class="reviewProductInfoRightBelowDiv">
                ...
                <span class="reviewProductInfoRightBelowText" >现在查看的是 您所租赁车辆的信息
于<fmt:formatDate value="${o.createDate}" pattern="yyyy年MM月dd"/>下单租用了此车辆 </span>
    ...
    <c:if test="${param.showonly!=true}">
        <div class="makeReviewDiv">
            <form method="post" action="foredoreview">
                <div class="makeReviewText">其他客户，需要你的建议哦！</div>
                <table class="makeReviewTable">
                    <tr>
                        <td class="makeReviewTableFirstTD">评价车辆</td>
