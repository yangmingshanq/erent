...
<div class="categorySortBar">
    ...
    <table class="categorySortBarTable categorySortTable">
        <tr>
            ...
            <td <c:if test="${'date'==param.sort}">class="grayColumn"</c:if>><a href="?cid=${c.id}&sort=date">新车<span class="glyphicon glyphicon-arrow-down"></span></a></td>
            <td <c:if test="${'saleCount'==param.sort}">class="grayColumn"</c:if>><a href="?cid=${c.id}&sort=saleCount">月租量<span class="glyphicon glyphicon-arrow-down"></span></a></td>
